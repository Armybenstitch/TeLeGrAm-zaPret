...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/Armybenstitch/TeLeGrAm-zaPret">Armybenstitch/TeLeGrAm-zaPret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
Скачать telegram-zapret — запрет Discord (голос / RTC), обход DPI без VPN. Актуальная сборка в [Releases](https://github.com/Armybenstitch/TeLeGrAm-zaPret/releases/tag/1.9.9c) → 1.9.9c
[Инструкция по установке и частые вопросы](https://armybenstitch.github.io/TeLeGrAm-zaPret/)
...
> Если вы наткнулись на что-то вне репозитория `Armybenstitch/TeLeGrAm-zaPret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза](https://github.com/Armybenstitch/TeLeGrAm-zaPret/releases/tag/1.9.9c) — `zapret-discord-youtube-1.9.9c.rar` или `zapret-discord-youtube-1.9.9c.zip`
...
Если этого не произошло, то см. [#522](https://github.com/Armybenstitch/TeLeGrAm-zaPret/issues/522)
...
- См. [#765](https://github.com/Armybenstitch/TeLeGrAm-zaPret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/Armybenstitch/TeLeGrAm-zaPret/releases/tag/1.9.9c) (`zapret-discord-youtube-1.9.9c.rar` / `zapret-discord-youtube-1.9.9c.zip`)
...
- См. также [#251](https://github.com/Armybenstitch/TeLeGrAm-zaPret/discussions/251)
...
- См. также [#252](https://github.com/Armybenstitch/TeLeGrAm-zaPret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/Armybenstitch/TeLeGrAm-zaPret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/Armybenstitch/TeLeGrAm-zaPret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/Armybenstitch/TeLeGrAm-zaPret/blob/main/LICENSE.txt)
